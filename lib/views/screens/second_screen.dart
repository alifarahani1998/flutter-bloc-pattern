...
import 'package:flutter_bloc_proj/views/screens/different_screen.dart';
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (_) => BlocProvider.value(
                              value: BlocProvider.of<PrinterCubit>(context),
                              child: DifferentScreen(
                                color: Colors.yellowAccent,
                                title: 'DifferentScreen',
                              ),
                            )));
              },
              color: widget.color,
              child: Text('Go to Different Page'),
            )
          ],
        ),
      ),
